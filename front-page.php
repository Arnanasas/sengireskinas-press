...
<p class="text-primary-green text-center leading-tight pb-20 text-lg lg:text-3xl lg:px-32 xl:px-80 tracking-5p ">
	„Sengirės kinas“ – tai naujas kiną ir edukaciją ekologijos tema
	jungiantis projektas, kurį įkvėpė Mindaugo Survilos filmo „Sengirė“
	poveikis siekiant apsaugoti senuosius Lietuvos miškus.
	<a href="#" class="underline">Plačiau</a>
</p>
          ...
          <div class="relative">
            <?php if (has_post_thumbnail()) : ?>
              <img
                ...
                class="w-full h-full object-cover <?php echo $image_class; ?>"
              />
            <?php endif; ?>
          </div>
