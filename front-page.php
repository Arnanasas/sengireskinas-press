...
<div class="text-primary-green text-center leading-tight! pb-20 text-lg lg:text-3xl lg:max-w-[831px] mx-auto tracking-5p lh-34-ls-5">
	<?php the_content(); ?>
</div>
      ...
      >
        ...
        <div class="flex justify-center flex-col lg:w-1/4 relative">
          ...
          <div class="text-center">
            <p
              class="text-sm lg:text-lg pb-1 pt-4 lg:pt-6 font-owners tracking-5p lh-34-ls-5"
            >
